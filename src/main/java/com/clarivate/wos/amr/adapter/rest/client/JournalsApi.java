...
package com.clarivate.wos.amr.adapter.rest.client;

import com.clarivate.wos.amr.adapter.rest.client.invoker.ApiCallback;
...
import com.clarivate.wos.amr.adapter.rest.client.invoker.ApiResponse;
import com.clarivate.wos.amr.adapter.rest.client.invoker.Configuration;
import com.clarivate.wos.amr.adapter.rest.client.invoker.Pair;
import com.clarivate.wos.amr.adapter.rest.client.invoker.ProgressRequestBody;
import com.clarivate.wos.amr.adapter.rest.client.invoker.ProgressResponseBody;
...
import com.clarivate.wos.amr.adapter.rest.client.model.Journal;
import com.clarivate.wos.amr.adapter.rest.client.model.JournalsList;
...
public class JournalsApi {
     ...
     */
    public okhttp3.Call journalsUidGetCall(String uid, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/journals/{uid}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call journalsUidGetValidateBeforeCall(String uid, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uid' is set
        if (uid == null) {
            throw new ApiException("Missing the required parameter 'uid' when calling journalsUidGet(Async)");
        }
        

        okhttp3.Call localVarCall = journalsUidGetCall(uid, _callback);
        return localVarCall;
     ...
     */
    public Journal journalsUidGet(String uid) throws ApiException {
        ApiResponse<Journal> localVarResp = journalsUidGetWithHttpInfo(uid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Journal> journalsUidGetWithHttpInfo(String uid) throws ApiException {
        okhttp3.Call localVarCall = journalsUidGetValidateBeforeCall(uid, null);
     ...
     */
    public okhttp3.Call journalsUidGetAsync(String uid, final ApiCallback<Journal> _callback) throws ApiException {

        okhttp3.Call localVarCall = journalsUidGetValidateBeforeCall(uid, _callback);
        Type localVarReturnType = new TypeToken<Journal>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
