...
import com.clarivate.wos.amr.adapter.rest.client.model.Metadata;
...
public class JournalsList {
  ...
  private List<Journal> hits = null;


  public JournalsList metadata(Metadata metadata) {
  ...
  **/
  ...
  public JournalsList hits(List<Journal> hits) {
    
    this.hits = hits;
    return this;
  }

  public JournalsList addHitsItem(Journal hitsItem) {
    if (this.hits == null) {
      this.hits = new ArrayList<Journal>();
    }
  ...
  **/
  ...
  public List<Journal> getHits() {
    return hits;
  }


  public void setHits(List<Journal> hits) {
    this.hits = hits;
  }
  ...
  public boolean equals(Object o) {
    ...
    JournalsList journalsList = (JournalsList) o;
    return Objects.equals(this.metadata, journalsList.metadata) &&
        Objects.equals(this.hits, journalsList.hits);
  }
