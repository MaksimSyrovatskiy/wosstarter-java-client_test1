...
package com.clarivate.wos.amr.adapter.rest.client.invoker;
...
import com.clarivate.wos.amr.adapter.rest.client.invoker.auth.Authentication;
import com.clarivate.wos.amr.adapter.rest.client.invoker.auth.HttpBasicAuth;
import com.clarivate.wos.amr.adapter.rest.client.invoker.auth.HttpBearerAuth;
import com.clarivate.wos.amr.adapter.rest.client.invoker.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "http://example.com";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://example.com
