...
public class JournalLinks {
  ...
  public JournalLinks type(String type) {
   ...
   /**
   * The type of URL that describes the product and page
   * @return type
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The type of URL that describes the product and page")
  ...
  public JournalLinks url(String url) {
   ...
   /**
   * URL of Web of Science Product
   * @return url
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "URL of Web of Science Product")
  ...
  public boolean equals(Object o) {
    ...
    JournalLinks journalLinks = (JournalLinks) o;
    return Objects.equals(this.type, journalLinks.type) &&
        Objects.equals(this.url, journalLinks.url);
  }
