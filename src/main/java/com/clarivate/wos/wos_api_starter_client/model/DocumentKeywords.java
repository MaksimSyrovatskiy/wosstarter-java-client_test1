 ...
 * Author keywords
 */
@ApiModel(description = "Author keywords")
...
public class DocumentKeywords {
  public static final String SERIALIZED_NAME_AUTHOR_KEYWORDS = "authorKeywords";
  @SerializedName(SERIALIZED_NAME_AUTHOR_KEYWORDS)
  private List<String> authorKeywords = null;

  public DocumentKeywords() { 
  }

  public DocumentKeywords authorKeywords(List<String> authorKeywords) {
    
    this.authorKeywords = authorKeywords;
    return this;
  }

  public DocumentKeywords addAuthorKeywordsItem(String authorKeywordsItem) {
    if (this.authorKeywords == null) {
      this.authorKeywords = new ArrayList<String>();
    }
    this.authorKeywords.add(authorKeywordsItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DocumentKeywords documentKeywords = (DocumentKeywords) o;
    return Objects.equals(this.authorKeywords, documentKeywords.authorKeywords);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorKeywords);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DocumentKeywords {\n");
    sb.append("    authorKeywords: ").append(toIndentedString(authorKeywords)).append("\n");
    sb.append("}");
    return sb.toString();
  }
