 ...
 * Web of Science URLs
 */
@ApiModel(description = "Web of Science URLs")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-04-06T14:35:04.758+02:00[Europe/Paris]")
public class DocumentLinks {
  public static final String SERIALIZED_NAME_RECORD = "record";
  @SerializedName(SERIALIZED_NAME_RECORD)
  private String record;

  public static final String SERIALIZED_NAME_CITING_ARTICLES = "citingArticles";
  @SerializedName(SERIALIZED_NAME_CITING_ARTICLES)
  ...
  public DocumentLinks record(String record) {
  ...
  **/
  ...
  public DocumentLinks citingArticles(String citingArticles) {
  ...
  **/
  ...
  public DocumentLinks references(String references) {
  ...
  **/
  ...
  public DocumentLinks related(String related) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.record, documentLinks.record) &&
        Objects.equals(this.citingArticles, documentLinks.citingArticles) &&
        Objects.equals(this.references, documentLinks.references) &&
        Objects.equals(this.related, documentLinks.related);
  }

  @Override
  public int hashCode() {
    return Objects.hash(record, citingArticles, references, related);
  }
  ...
  public String toString() {
    ...
    sb.append("    citingArticles: ").append(toIndentedString(citingArticles)).append("\n");
