...
public class DocumentCitations {
  ...
  public DocumentCitations() { 
  }

  public DocumentCitations db(String db) {
   ...
   /**
   * Web of Science Citation Database (collection) Abbreviation Name
   * @return db
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "WOS", value = "Web of Science Citation Database (collection) Abbreviation Name")
  ...
  public DocumentCitations count(Integer count) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Citation Count")
  ...
  public boolean equals(Object o) {
    ...
    DocumentCitations documentCitations = (DocumentCitations) o;
    return Objects.equals(this.db, documentCitations.db) &&
        Objects.equals(this.count, documentCitations.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(db, count);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DocumentCitations {\n");
